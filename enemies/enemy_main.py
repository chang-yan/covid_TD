...
class Enemy:
    def __init__(self):
        ...
        self.path = [(22, 308), (52, 283), (84, 283), (110, 305), (116, 341),
                     ...
                     (533, 230), (532, 196)]
        self.path = [(x, y-30) for x, y in self.path]
    ...
    def collide(self, obj_x, obj_y):
        ...
        :return: Bool
        """
        if self.x - 10 <= obj_x <= self.x + self.width + 10 and\
                self.y - 10 <= obj_y <= self.y + self.height + 10:
            return True
        return False
    ...
    def occur_mutation(self, win):
        ...
        if self.mutation == 1:
            # draw
            #pygame.draw.ellipse(win, (147, 0, 147), (self.x+16, self.y-10, 25, 12),3)
            win.blit(virus_img1, (self.x - virus_img1.get_width()//2, self.y - 50))
            #self.health += 1/100
            #self.max_health += 1/100
        else:
